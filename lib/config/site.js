...
export const siteConfig = {
  ...
  tagline: "We craft brands & digital experiences that convert",
  shortDescription:
    "An award-winning creative studio building websites, brands, and products that move business forward.",
  logoText: "Nexus",
  ...
  social: {
    ...
    twitter: "https://x.com/nexusstudio",
    github: "https://github.com/nexusstudio",
    behance: "https://behance.net/nexusstudio",
  ...
  testimonials: [
    {
      ...
      quote:
        "Nexus rebuilt our brand and site in six weeks. Revenue is up 3.2x. They think like founders, execute like a top studio.",
      avatar:
  ...
  seo: {
    metaTitle:
      "Nexus Studio — Award-winning Digital Design & Development Agency",
    metaDescription:
      "Nexus Studio is a creative agency crafting brands, websites, and products that convert. Trusted by startups & Fortune 500s.",
    keywords: [
      "digital agency",
      "web design",
      "branding",
